...
class NodeTree(object):
    ...
    def count(self): 							 #conta il numero di nodi
        ...
        for elnode in self.content: cnode += elnode.count()  #scansiono figli dei nodi aumentando 
                                                                            #via via il contatore
    ...
    def count_by_name(self, name): 		   		    #conta numero figli nodo name
        ...
        for elnode in self.content: cnode += elnode.count_by_name(name) #scansiona i nodi e fa la 
									 #ricorsione su ogni nodo
...
def create_tree(d): 					   	    #crea albero dal dizionario d
    ...
    for i in range(len(d["children"])): 		 		  #scansiona i nodi figli
        ...
        elnode.add_child(create_tree(cnode))  #aggiunge all'albero ricors figlio con indice cnode
